    ...
    return (
      <Stack direction="column" justifyContent="center" pb={10} spacing={5}>
        <Stack justifyContent="space-between" mr={5} alignItems="center">
          <Typography level="body-lg">General Space Permissions</Typography>
          <Button
            color="danger"
        ...
        <Stack direction="column" spacing={2.5}>
          <Stack alignItems="center">
            <Typography level="body-lg">Text Channel Permissions</Typography>
          </Stack>
          <PermissionItem
            flag="SendMessages"
            label="Send Messages"
        ...
        <Stack direction="column" spacing={2.5}>
          <Stack alignItems="center">
            <Typography level="body-lg">Voice Channel Permissions</Typography>
          </Stack>
          <PermissionItem
            flag="Connect"
            label="Connect"
