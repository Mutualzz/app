...
export const GoogleFontPicker = ({
  ...
  const uploadFont = async (file: File) => {
    ...
    try {
      ...
      setCustomLabel(result.displayName ?? file.name.replace(/\.woff2$/i, ""));
    ...
    <Stack direction="column" spacing={1.25}>
      ...
      >
        ...
        {filteredFonts.length === 0 && !showCustomWebFont ? (
          <Typography level="body-xs" css={{ opacity: 0.65, px: 0.75, py: 0.5 }}>
            {trimmedQuery
            ...
            return (
              ...
              >
                <Stack
                  ...
                  spacing={1}
                >
                  <Typography level="body-sm" fontWeight={selected ? 700 : 500}>
                    {font.family}
                  </Typography>
                  <Typography level="body-xs" css={{ opacity: 0.55, flexShrink: 0 }}>
      ...
      <Stack direction="column" spacing={0.75}>
        ...
        <Typography level="body-xs" css={{ opacity: 0.55, lineHeight: 1.4 }}>
          WOFF2 only, up to 2 MB. Loads on demand when your theme or profile is viewed.
        </Typography>
      </Stack>
