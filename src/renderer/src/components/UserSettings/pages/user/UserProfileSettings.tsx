    ...
    >
      <Stack direction="column" spacing={0.75}>
        ...
        >
          <Popover
            trigger={
              <Button disabled={isPending} size={{ xs: "sm", sm: "md" }}>
                Change Avatar
              </Button>
            }
            closeOnInteract
          >
            <ButtonGroup disabled={isPending} size={{ xs: "sm", sm: "md" }}>
              <Button
                onClick={() => {
              ...
              <Button onClick={() => openModal("avatar-draw", <AvatarDraw />)}>
                Draw
              </Button>
              <Button onClick={() => openModal("avatars", <Avatars />)}>
                Avatars
              </Button>
            </ButtonGroup>
          </Popover>
