...
export const PostComposer = observer(
  forwardRef<PostComposerHandle, Props>(function PostComposer(
    { onPosted },
    ref
  ) {
    ...
    const addFiles = (incoming: FileList | File[] | null | undefined) => {
      ...
      const next = Array.from(incoming).filter(
        (file) =>
          (!file.type || ACCEPTED_MIME_TYPE_SET.has(file.type)) &&
      ...
      >
        ...
        >
          <Stack direction="row" spacing={1} alignItems="center">
            ...
            <Tooltip
              content={t("feed.composer.schedulePost")}
              placement="bottom"
            >
              <IconButton
            ...
            <Tooltip
              content={t("feed.composer.viewScheduled")}
              placement="bottom"
            >
